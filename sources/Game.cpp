 ...
 using namespace ariel;
        ...
        void Game::printWiner(){
            if(p1->cardesTaken() == p2->cardesTaken() && p1->stacksize() == 0 )
               cout<<"Two players looted the same amount of cards.";
            ...
            if(winner == 0)
               cout<<"No winner yet!"<<endl;
                 ...
                 else cout<<" Game finished at a tie!";
        }
       ...
       void Game::gotoWar(){    
             ...
             if(p1->stacksize()<4 && p2->stacksize()<4 ){
               ...
               for(int i=0; i < stackSize; i++)
                  {
                    cout<<"p1 stacksize="<<p1->stacksize()<<" looting.."<<endl;
           ...
           if(p1->stacksize() > 4)//if these are not the last 4 cards.
           {
